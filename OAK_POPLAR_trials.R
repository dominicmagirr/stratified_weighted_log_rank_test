...
res_strata <- swlrt_fast(df = data_oak_final,
                         trt_colname = "group",
                         time_colname = "time",
                         event_colname = "event",
...
res_strata_0 <- swlrt_fast(df = data_oak_final,
                           trt_colname = "group",
                           time_colname = "time",
                           event_colname = "event",
                           strat_colname = "strata",
...
res_unstrata <- wlrt_fast(df = data_oak_final,
                          trt_colname = "group",
                          time_colname = "time",
                          event_colname = "event",
                          wlr = "mw",
...
res_unstrata_0 <- wlrt_fast(df = data_oak_final,
                            trt_colname = "group",
                            time_colname = "time",
                            event_colname = "event",
                            wlr = "mw",
...
res_strata <- swlrt_fast(df = data_poplar_final,
                         trt_colname = "group",
                         time_colname = "time",
                         event_colname = "event",
                         strat_colname = "strata",
...
res_strata_0 <- swlrt_fast(df = data_poplar_final,
                           trt_colname = "group",
                           time_colname = "time",
                           event_colname = "event",
                           strat_colname = "strata",
...
res_unstrata <- wlrt_fast(df = data_poplar_final,
                          trt_colname = "group",
                          time_colname = "time",
                          event_colname = "event",
                          wlr = "mw",
...
res_unstrata_0 <- wlrt_fast(df = data_poplar_final,
                            trt_colname = "group",
                            time_colname = "time",
                            event_colname = "event",
                            wlr = "mw",
...
coxph(Surv(OS, OS.EVENT) ~ ECOGGR, data = data_poplar)
